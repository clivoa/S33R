...
(function () {
  ...
  function build() {
    ...
    nav.innerHTML =
      `<a class="rail-logo" href="${hrefFor("S33R Feed.html", "")}" title="S33R"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round">${ICONS.shield}</svg></a>` +
